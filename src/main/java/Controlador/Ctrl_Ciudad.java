...
public class Ctrl_Ciudad {
    ...
    public Ctrl_Ciudad() {
        ...
        ciudades.add(new Ciudad("Córdoba", EnumProvincia.CORDOBA));
        ciudades.add(new Ciudad("Corrientes", EnumProvincia.CORRIENTES));
        ciudades.add(new Ciudad("Paraná", EnumProvincia.ENTRE_RIOS));
        ...
        ciudades.add(new Ciudad("Neuquén", EnumProvincia.NEUQUEN));
        ...
        ciudades.add(new Ciudad("Río Gallegos", EnumProvincia.SANTA_CRUZ));
        ...
        ciudades.add(new Ciudad("San Miguel de Tucumán", EnumProvincia.TUCUMAN));
    }
